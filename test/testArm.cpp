...
int main() {
    ...
    for(cpu_log log : logs) {
        ...
        uint32_t instrAddress = cpu.getRegisterDebug(15);
        ...
        ASSERT_EQUAL("r0", log.r[0], cpu.getRegisterDebug(0))
        ASSERT_EQUAL("r1", log.r[1], cpu.getRegisterDebug(1))
        ASSERT_EQUAL("r2", log.r[2], cpu.getRegisterDebug(2))
        ASSERT_EQUAL("r3", log.r[3], cpu.getRegisterDebug(3))
        ASSERT_EQUAL("r4", log.r[4], cpu.getRegisterDebug(4))
        ASSERT_EQUAL("r5", log.r[5], cpu.getRegisterDebug(5))
        ASSERT_EQUAL("r6", log.r[6], cpu.getRegisterDebug(6))
        ASSERT_EQUAL("r7", log.r[7], cpu.getRegisterDebug(7))
        ASSERT_EQUAL("r8", log.r[8], cpu.getRegisterDebug(8))
        ASSERT_EQUAL("r9", log.r[9], cpu.getRegisterDebug(9))
        ASSERT_EQUAL("r10", log.r[10], cpu.getRegisterDebug(10))
        ASSERT_EQUAL("r11", log.r[11], cpu.getRegisterDebug(11))
        ASSERT_EQUAL("r12", log.r[12], cpu.getRegisterDebug(12))
        ASSERT_EQUAL("r13", log.r[13], cpu.getRegisterDebug(13))
        ASSERT_EQUAL("r14", log.r[14], cpu.getRegisterDebug(14))
        if(log.cpsr & 0x00000020) {
            // in thumb state add 2 to PC to account for pipelining
            ASSERT_EQUAL("r15", log.r[15], cpu.getRegisterDebug(15) + 2)
        } else {
            // in arm state add 4 to PC to account for pipelining
            ASSERT_EQUAL("r15", log.r[15], cpu.getRegisterDebug(15) + 4)
        }
